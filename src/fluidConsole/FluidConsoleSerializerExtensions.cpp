...
namespace FluidConsole
{
    ...
    bool IgnoreUnkownVisualizerExtension::can_serialize(
        const std::shared_ptr<LibFluid::ISimulationVisualizer> &visualizer) const
    {
        return false;
    }
    nlohmann::json IgnoreUnkownVisualizerExtension::serialize_visualizer(
    ...
    std::shared_ptr<LibFluid::ISimulationVisualizer> IgnoreUnkownVisualizerExtension::deserialize_visualizer(
