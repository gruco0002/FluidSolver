 ...
 * binary files into the current translation unit and
 ...
 * the shift count. This is the
 * value passed to `.align'
 */
 ...
 *
 * @warning If you use this
 * facility, you'll have to deal with platform-specific linker output
 * section naming on your own
 *
 * Overriding the
 * default linker output section, e.g for esp8266/Arduino:
 * @code
 * #define INCBIN_OUTPUT_SECTION ".irom.text"
 *
 * #include "incbin.h"
 * INCBIN(Foo, "foo.txt");
 * // Data is emitted into program memory that never gets copied to
 * RAM
 * @endcode
 */
 ...
 * type and concatenating the name against
 * them. */
 ...
 *
 * Produces three external
 * symbols that reference the binary data included in
 * another translation unit.
 *
 * The symbol names are a
 * concatenation of `INCBIN_PREFIX' before *NAME*; with
 * "Data", as well as "End" and "Size" after. An example is
 * provided below.
 *
 ...
 *
 * Includes a binary file into the current
 * translation unit, producing three symbols
 * for objects that encode the data and size respectively.
 *
 * The symbol
 * names are a concatenation of `INCBIN_PREFIX' before *NAME*; with
 * "Data", as well as "End" and "Size" after. An
 ...
 * @endcode
 *
 * @warning This must be used in global
 * scope
 * @warning The identifiers may be different if INCBIN_STYLE is not default
 *
 * To externally reference the
 * data included by this in another translation unit
