...
FluidSolver::QuadraticNeighborhoodSearchDynamicAllocated::Neighbors FluidSolver::
...
FluidSolver::QuadraticNeighborhoodSearchDynamicAllocated::particleIndex_t& FluidSolver::
...
const FluidSolver::QuadraticNeighborhoodSearchDynamicAllocated::NeighborsIterator FluidSolver::
...
FluidSolver::QuadraticNeighborhoodSearchDynamicAllocated::NeighborsIterator& FluidSolver::
    QuadraticNeighborhoodSearchDynamicAllocated::NeighborsIterator::operator++()
{
    FLUID_ASSERT(data != nullptr);
