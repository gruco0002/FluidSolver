...
FluidSolver::NeighborsCompact FluidSolver::QuadraticNeighborhoodSearchGreedyAllocated::GetNeighbors(
...
FluidSolver::NeighborsCompactData FluidSolver::QuadraticNeighborhoodSearchGreedyAllocated::GetNeighbors(
    glm::vec2 position)
{
    // TODO: implement
