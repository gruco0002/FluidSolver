...
namespace FluidSolver {
	 ...
	 * the access to the neighborhood search.
	 * 
	 ...
	 * created. It wraps any iterator into its own (not templated) iterator. Calls to
	 * the original iterator are realized through function objects.
	 * The NeighborhoodInterface provides the basic requirements of the Neighbor object
	 * used in the neighborhood searches.
	 */
