...
namespace FluidSolver {
    ...
    void SESPHFluidSolver<Kernel, NeighborhoodSearch>::execute_simulation_step(pFloat timestep) {
...
#pragma omp parallel for
    ...
    template<typename Kernel, typename NeighborhoodSearch>
    void SESPHFluidSolver<Kernel, NeighborhoodSearch>::initialize() {
    ...
    template<typename Kernel, typename NeighborhoodSearch>
    pFloat SESPHFluidSolver<Kernel, NeighborhoodSearch>::ComputePressure(pIndex_t particleIndex) {
    ...
    template<typename Kernel, typename NeighborhoodSearch>
    pFloat SESPHFluidSolver<Kernel, NeighborhoodSearch>::ComputeDensity(pIndex_t particleIndex) {
    ...
    template<typename Kernel, typename NeighborhoodSearch>
    vec2 SESPHFluidSolver<Kernel, NeighborhoodSearch>::ComputeNonPressureAcceleration(pIndex_t particleIndex) {
    ...
    template<typename Kernel, typename NeighborhoodSearch>
    vec2 SESPHFluidSolver<Kernel, NeighborhoodSearch>::ComputePressureAcceleration(pIndex_t particleIndex) {
        const glm::vec2 &position = collection->get<MovementData>(particleIndex).position;
    ...
    template<typename Kernel, typename NeighborhoodSearch>
    vec2 SESPHFluidSolver<Kernel, NeighborhoodSearch>::ComputeViscosityAcceleration(pIndex_t particleIndex) {
        const glm::vec2 &position = collection->get<MovementData>(particleIndex).position;
