...
void
Engine::Text::TextRenderer::Render(std::string text, float x, float y, float size, glm::vec4 color, glm::vec4 clipArea,
                                   glm::vec4 blendArea) {
    RenderOutlined(text, x, y, size, color, glm::vec4(1.0f), 0.0f, clipArea, blendArea);
}

void
Engine::Text::TextRenderer::RenderOutlined(std::string text, float x, float y, float size, glm::vec4 color,
...
void Engine::Text::TextRenderer::CreateVertexArray() {
    ...
    Graphics::Buffer::VertexArray::BufferBinding rectangleBufferBinding(rectangleBuffer, 0, 2,
                                                                        0, sizeof(float) * 2,
                                                                        ComponentTypeFloat);

    Graphics::Buffer::VertexArray::BufferBinding vertexBufferBinding(vertexBuffer, 1, 3,
                                                                     0, sizeof(glm::vec3),
