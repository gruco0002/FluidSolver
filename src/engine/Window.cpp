...
namespace Engine
{
    ...
    void Window::setCallbacks()
    {
        ...
        onAnyWindowSizeChangedSubscription = onAnyWindowSizeChanged.Subscribe(std::bind(
            &Window::onWindowSizeChanged, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));
        ...
        onAnyScrollChangedSubscription = onAnyScrollChanged.Subscribe(std::bind(
            &Window::onScrollChanged, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));

        glfwSetKeyCallback(window, key_callback);
        onAnyKeyChangedSubscription = onAnyKeyChanged.Subscribe(
            std::bind(&Window::onKeyChanged, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3,
