    ...
    void ParticleVertexArray3DForCollection::OnGenerate()
    {
        ...
        this->vao = new Engine::Graphics::Buffer::VertexArray({
            ...
            Engine::Graphics::Buffer::VertexArray::BufferBinding(
                movementBuffer, 1, 3, offsetof(LibFluid::MovementData3D, position), sizeof(LibFluid::MovementData3D),
                Engine::ComponentTypeFloat),
            Engine::Graphics::Buffer::VertexArray::BufferBinding(
                movementBuffer, 2, 3, offsetof(LibFluid::MovementData3D, velocity), sizeof(LibFluid::MovementData3D),
                Engine::ComponentTypeFloat),
            Engine::Graphics::Buffer::VertexArray::BufferBinding(
