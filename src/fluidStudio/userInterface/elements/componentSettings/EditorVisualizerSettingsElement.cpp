...
namespace FluidStudio
{
    ...
    void EditorVisualizerSettingsElement::update()
    {
        ...
        {
            auto visualizer =
                std::dynamic_pointer_cast<LibFluid::ISimulationVisualizer>(ui_data.window().editor_visualizer);
        ...
        if (StyledImGuiElements::slim_tree_node("Colors"))
        {
            ...
            if (gl3d != nullptr)
            {
                ...
                ImGui::ColorEdit4("Boundary", (float *)&gl3d->settings.boundary_particle_color,
        ...
        if (StyledImGuiElements::slim_tree_node("View"))
        {
            if (ImGui::Button("Transfer View to Simulation Visualizer"))
            {
                ...
                {
                    ui_data.window().simulator_visualizer_bundle.visualizer->set_view(position, view_direction,
                                                                                      view_up);
                }
            }
