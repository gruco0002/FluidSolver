    ...
    void InsertParticlesWindow::update()
    {
        ...
        if (ImGui::Begin("Insert Particles", &is_open))
        {
            ...
            if (ImGui::BeginCombo("Type",
                                  TypeInformationProvider::particle_type_to_string(particle_settings.particle_type)))
            {
                if (ImGui::Selectable(
                        TypeInformationProvider::particle_type_to_string(LibFluid::ParticleType::ParticleTypeNormal),
                ...
                if (ImGui::Selectable(
                        TypeInformationProvider::particle_type_to_string(LibFluid::ParticleType::ParticleTypeBoundary),
                ...
                if (ImGui::Selectable(
                        TypeInformationProvider::particle_type_to_string(LibFluid::ParticleType::ParticleTypeInactive),
