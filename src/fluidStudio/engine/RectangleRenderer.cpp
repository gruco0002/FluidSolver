...
void Engine::RectangleRenderer::Generate()
{
    ...
    vertexBuffer =
        new Engine::Graphics::Buffer::VertexBuffer<glm::vec2>(4, Engine::Graphics::Buffer::Buffer::DataModeDynamic);
    ...
    auto indices = std::vector<uint8_t>{0, 1, 2, 0, 2, 3};
    indexBuffer = new Engine::Graphics::Buffer::IndexBuffer<uint8_t>(indices);
    vertexArray = new Engine::Graphics::Buffer::VertexArray({
        Engine::Graphics::Buffer::VertexArray::BufferBinding(vertexBuffer, 0, 2, offsetof(glm::vec2, x),
                                                             sizeof(glm::vec2), ComponentTypeFloat),
        Engine::Graphics::Buffer::VertexArray::BufferBinding(textureCoordBuffer, 1, 2, offsetof(glm::vec2, x),
                                                             sizeof(glm::vec2), ComponentTypeFloat),
