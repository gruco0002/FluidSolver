...
namespace LibFluid
{
    ...
    void Lz4CompressedStream::write(const char *data, size_t length)
    {
        ...
        size_t compressed_data_size =
            LZ4F_compressUpdate(reinterpret_cast<LZ4F_cctx *>(this->compression_context), write_heap_buffer.data(),
                                compressed_data_max_size, data, length, nullptr);
            ...
            else
            {
                ...
                if (read_source_buffer.has_data())
                {
                    ...
                    size_t result = LZ4F_decompress(reinterpret_cast<LZ4F_dctx *>(this->decompression_context),
                                                    ...
                                                    read_source_buffer.data(), &source_size, &options);
    ...
    void Lz4CompressedStream::initialize_read()
    {
        LZ4F_errorCode_t error_code = LZ4F_createDecompressionContext(
            reinterpret_cast<LZ4F_dctx **>(&this->decompression_context), LZ4F_getVersion());
    ...
    void Lz4CompressedStream::finalize_read()
    {
        LZ4F_errorCode_t error_code =
            LZ4F_freeDecompressionContext(reinterpret_cast<LZ4F_dctx *>(this->decompression_context));
    ...
    void Lz4CompressedStream::initialize_write()
    {
        ...
        LZ4F_errorCode_t error_code = LZ4F_createCompressionContext(
            reinterpret_cast<LZ4F_cctx **>(&this->compression_context), LZ4F_getVersion());
        if (LZ4F_isError(error_code))
        {
        ...
        size_t header_size = LZ4F_compressBegin(reinterpret_cast<LZ4F_cctx *>(this->compression_context), header_data,
                                                LZ4F_HEADER_SIZE_MAX, nullptr);
    ...
    void Lz4CompressedStream::finalize_write()
    {
        ...
        size_t end_size = LZ4F_compressEnd(reinterpret_cast<LZ4F_cctx *>(this->compression_context), end_data.data(),
                                           end_data.size(), nullptr);
        ...
        // free the context
        LZ4F_errorCode_t error_code =
            LZ4F_freeCompressionContext(reinterpret_cast<LZ4F_cctx *>(this->compression_context));
