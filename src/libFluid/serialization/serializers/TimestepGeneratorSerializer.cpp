...
namespace LibFluid::Serialization
{
    ...
    nlohmann::json TimestepGeneratorSerializer::serialize_constant_timestep_generator(
        std::shared_ptr<TimestepGenerator> timestep_generator)
    {
    ...
    nlohmann::json TimestepGeneratorSerializer::serialize_dynamic_cfl_timestep_generator(
        std::shared_ptr<TimestepGenerator> timestep_generator)
    {
    ...
    std::shared_ptr<TimestepGenerator> TimestepGeneratorSerializer::deserialize_constant_timestep_generator(
    ...
    std::shared_ptr<TimestepGenerator> TimestepGeneratorSerializer::deserialize_dynamic_cfl_timestep_generator(
        const nlohmann::json &node)
    {
