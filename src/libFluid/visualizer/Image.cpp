...
namespace LibFluid
{
    ...
    Image::Color::Color(unsigned char r, unsigned char g, unsigned char b) : r(r), g(g), b(b), a(255)
    {
    }

    Image::Color::Color(unsigned char r, unsigned char g, unsigned char b, unsigned char a) : r(r), g(g), b(b), a(a)
    {
    }
    ...
    Image::Image(size_t width, size_t height) : v_width(width), v_height(height)
    {
