...
FluidSolver::NeighborhoodInterface::NeighborsIterator& FluidSolver::NeighborhoodInterface::NeighborsIterator::
operator++()
{
    FLUID_ASSERT(data != nullptr);
...
const FluidSolver::NeighborhoodInterface::NeighborsIterator FluidSolver::NeighborhoodInterface::NeighborsIterator::
operator++(int)
{
...
FluidSolver::NeighborhoodInterface::Neighbors FluidSolver::NeighborhoodInterface::get_neighbors(
