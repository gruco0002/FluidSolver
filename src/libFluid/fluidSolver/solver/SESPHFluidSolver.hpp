...
namespace LibFluid
{
    ...
    void SESPHFluidSolver<Kernel, NeighborhoodSearch, parallel>::execute_simulation_step(Timepoint &timestep)
    {
        ...
        parallel::loop_for(0, data.collection->size(), [&](size_t i) {
            ...
            data.collection->get<MovementData>(i).position =
                data.collection->get<MovementData>(i).position +
    ...
    template <typename Kernel, typename NeighborhoodSearch, typename parallel>
    void SESPHFluidSolver<Kernel, NeighborhoodSearch, parallel>::create_compatibility_report(
    ...
    template <typename Kernel, typename NeighborhoodSearch, typename parallel>
    inline std::shared_ptr<NeighborhoodInterface> SESPHFluidSolver<Kernel, NeighborhoodSearch,
    ...
    template <typename Kernel, typename NeighborhoodSearch, typename parallel>
    glm::vec2 SESPHFluidSolver<Kernel, NeighborhoodSearch, parallel>::ComputeNonPressureAcceleration(
