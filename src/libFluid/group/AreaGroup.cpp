...
namespace LibFluid
{
    bool AreaGroup::AreaGroupIterator::operator==(const AreaGroup::AreaGroupIterator &other) const
    {
    ...
    AreaGroup::AreaGroupIterator &AreaGroup::AreaGroupIterator::operator++()
    {
    ...
    const AreaGroup::AreaGroupIterator AreaGroup::AreaGroupIterator::operator++(int)
    {
        FLUID_ASSERT(data != nullptr)
        FLUID_ASSERT(data->collection != nullptr)
